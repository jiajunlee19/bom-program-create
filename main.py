...
def main(log, path_main, path_590, path_MCTO, path_recipe_bom_master, path_recipe_bom_new, path_bom):
    ...
    selected_MCTO = set(df_input['MCTO_MASTER']).union(set(df_input['MCTO_NEW']))
    ...
    if SAP_SOURCE == 'manual':
        ...
        query_MCTO = '''
                    ...
                    where REPLACE(bh.SAP_mat_no, '000000000000', '') in ({0});
                '''
    ...
    log.debug('Inner joining df_590 to df_590_MCTO_PV on BOM and drop duplicates...')
    ...
    log.debug('Inner joining df_MCTO to df_590_MCTO_PV on MCTO and drop duplicates...')
